...
__all__ = [
    'SRTReSent', 'SPWT_LEXICAL',
    'DISPID_SRAllowAudioInputFormatChangesOnNextSet',
    'DISPID_SRCCmdMaxAlternates', 'DISPID_SPRFirstElement',
    'DISPID_SGRClear', 'DISPID_SRCEventInterests', 'SPAS_STOP',
    'SPSHT_EMAIL', 'SP_VISEME_5',
    'SPINTERFERENCE_LATENCY_TRUNCATE_END',
    'DISPID_SGRSAddRuleTransition', 'ISpeechMMSysAudio',
    'SGRSTTWildcard', 'DISPID_SPPsCount', 'DISPID_SWFEBitsPerSample',
    'SPXRO_SML', 'SpeechDiscardType', 'SpCompressedLexicon',
    'ISpNotifySource', 'DISPID_SADefaultFormat', 'ISpeechAudioStatus',
    'DISPID_SRSSupportedLanguages', 'Speech_StreamPos_RealTime',
    'DISPID_SRGState', 'eLEXTYPE_PRIVATE7', 'SREFalseRecognition',
    'SPEI_VISEME', 'DISPID_SGRSTs_NewEnum', 'ISpeechRecoResult2',
    'SVSFUnusedFlags', 'DISPID_SOTCreateInstance', 'SP_VISEME_10',
    'eLEXTYPE_VENDORLEXICON', 'ISpPhoneticAlphabetSelection',
    'SAFTADPCM_8kHzMono', 'SVEAudioLevel',
    'DISPID_SpeechPhraseReplacement',
    'DISPID_SRAllowVoiceFormatMatchingOnNextSet',
    'SAFTADPCM_44kHzMono', 'DISPID_SOTRemoveStorageFileName',
    'SAFTTrueSpeech_8kHz1BitMono', 'SpeechRecoEvents',
    'DISPID_SGRSTsCount', 'ISpeechWaveFormatEx', 'ISequentialStream',
    'UINT_PTR', 'DISPID_SGRName', 'DISPID_SVEventInterests',
    'SP_VISEME_16', 'SECFIgnoreWidth', 'SpeechTokenKeyFiles',
    '__MIDL___MIDL_itf_sapi_0000_0020_0002', 'SITooQuiet',
    'DISPID_SVEAudioLevel', 'DISPID_SpeechDataKey',
    'DISPID_SOTMatchesAttributes', 'DISPID_SGRId',
    'SpSharedRecoContext', 'SPFM_OPEN_READONLY', 'SGLexical',
    'Speech_Max_Pron_Length', 'SPWAVEFORMATTYPE', 'SVP_18',
    'SRAInterpreter', 'DISPID_SGRSTransitions',
    'SAFTCCITT_uLaw_22kHzMono', 'IStream',
    'DISPID_SpeechLexiconPronunciation', 'DISPID_SLWsCount',
    'SAFTGSM610_11kHzMono', 'SAFTADPCM_44kHzStereo',
    'SpeechCategoryRecognizers', 'SPWF_INPUT', 'SPLOADOPTIONS',
    'DISPID_SPPChildren', 'SPEI_UNDEFINED',
    'SAFTCCITT_uLaw_44kHzMono', 'SAFTCCITT_uLaw_8kHzMono', 'SPWORD',
    'SSFMCreateForWrite', 'SpPhoneConverter',
    'DISPIDSPTSI_ActiveOffset', 'SAFT11kHz8BitMono', 'SLODynamic',
    'ISpRecognizer2', 'SPRECOSTATE', 'ISpeechPhoneConverter',
    'DISPID_SDKSetLongValue', 'SpeechVoicePriority',
    'SAFTCCITT_ALaw_22kHzMono', 'DISPID_SPRText', 'SPEI_RESERVED2',
    'DISPID_SRGSetTextSelection', 'DISPID_SLGenerationId',
    'DISPID_SPIReplacements', 'ISpRecoGrammar',
    'DISPID_SVSyncronousSpeakTimeout', 'SpeechAudioFormatGUIDText',
    'SpeechTokenValueCLSID', 'DISPID_SRCERecognitionForOtherContext',
    'DISPID_SGRsCommit', 'SVSFIsNotXML', 'SPSTREAMFORMATTYPE',
    'SAFTCCITT_ALaw_11kHzStereo', 'SPSHORTCUTPAIR',
    'ISpeechVoiceStatus', 'DISPID_SDKDeleteKey',
    'DISPID_SPRuleEngineConfidence', 'SVP_13',
    'SpeechPropertyComplexResponseSpeed', 'SSFMCreate',
    'SPLO_DYNAMIC', 'DISPID_SRRPhraseInfo', 'SPVPRIORITY',
    'eLEXTYPE_PRIVATE18', 'SPWP_KNOWN_WORD_PRONOUNCEABLE',
    'SPPS_Interjection', 'SpeechTokenContext',
    'DISPID_SpeechRecoResultTimes', 'DISPID_SVGetAudioOutputs',
    'DISPID_SLAddPronunciationByPhoneIds', 'DISPID_SDKGetStringValue',
    'DISPID_SRCSetAdaptationData', 'eLEXTYPE_PRIVATE14',
    'SPEI_RECO_STATE_CHANGE', 'ISpStreamFormatConverter',
    'DISPID_SPIEnginePrivateData', 'STCRemoteServer',
    'SpStreamFormatConverter', 'SITooFast', 'SPCONTEXTSTATE',
    'SPEI_MIN_TTS', 'SPAUDIOSTATE', 'DISPID_SVEWord',
    'DISPID_SRCRequestedUIType', 'DISPID_SpeechPhraseProperty',
    'SAFT16kHz8BitMono', 'SAFT24kHz16BitStereo', 'SpeechGrammarState',
    '_RemotableHandle', 'SPAO_RETAIN_AUDIO', 'SPINTERFERENCE_TOOFAST',
    'DISPID_SGRsDynamic', 'DISPID_SMSSetData', 'SVSFPersistXML',
    'ISpeechRecognizer', 'DISPID_SPPNumberOfElements',
    'DISPID_SVESentenceBoundary', 'SAFTCCITT_ALaw_8kHzStereo',
    'SP_VISEME_19', 'DISPID_SRCERecognizerStateChange',
    'ISpeechRecoResultDispatch', 'DISPID_SRRTimes', 'SpCustomStream',
    'ISpRecoGrammar2', 'DISPID_SRCRetainedAudio',
    'SVEStartInputStream', 'SVP_3', 'SPPS_SuppressWord',
    '_SPAUDIOSTATE', 'SPFM_CREATE_ALWAYS', 'SPRS_INACTIVE',
    'SPSHT_NotOverriden', 'SGDSInactive', 'SpeechCategoryVoices',
    'DISPID_SRRTOffsetFromStart', 'SAFT44kHz16BitMono',
    'DISPIDSPTSI_SelectionOffset', 'SpMMAudioEnum',
    'DISPID_SASFreeBufferSpace', 'SpeechCategoryAudioIn',
    'ISpeechRecognizerStatus', 'SPPS_LMA', 'SPPS_Function',
    'DISPID_SABufferNotifySize', 'SpeechRecognitionType',
    'ISpObjectWithToken', 'SAFTCCITT_ALaw_44kHzMono',
    'SpeechAudioProperties', 'SpFileStream', 'SPFM_CREATE',
    'eLEXTYPE_PRIVATE12', 'SpeechStreamFileMode',
    'SAFTNonStandardFormat', 'SDTLexicalForm',
    'SpeechGrammarTagWildcard', 'eLEXTYPE_RESERVED7', 'SRAONone',
    'ISpeechGrammarRuleStateTransition', 'SECFDefault', 'SPEVENT',
    'SVSFParseMask', 'SDTAll', 'SpInProcRecoContext',
    'SAFTCCITT_ALaw_8kHzMono', 'DISPID_SRSetPropertyNumber',
    'ISpeechPhraseInfo', 'SPRS_ACTIVE_USER_DELIMITED',
    'eLEXTYPE_RESERVED8', 'SPAR_High', 'SRSEIsSpeaking',
    'SpeechAudioState', 'SDA_Consume_Leading_Spaces', 'SVSFParseSsml',
    'DISPID_SpeechPhraseRule', 'SPSMF_UPS', 'SpInprocRecognizer',
    'DISPID_SRGCmdLoadFromFile', 'DISPID_SRRSetTextFeedback',
    'LONG_PTR', 'IInternetSecurityMgrSite', 'SpeechGrammarWordType',
    'DISPID_SPRsCount', 'ISpEventSource', 'SPINTERFERENCE_TOOLOUD',
    'SpeechRetainedAudioOptions', 'DISPID_SpeechMemoryStream',
    'SPAS_RUN', 'DISPID_SDKGetBinaryValue',
    'SPINTERFERENCE_LATENCY_WARNING', 'eLEXTYPE_PRIVATE4',
    'SpeechRecoContextState', 'DISPID_SBSWrite', 'SpeechWordType',
    'ISpGrammarBuilder', 'DISPID_SPIAudioSizeTime',
    'SAFT44kHz8BitMono', 'SpeechPartOfSpeech', 'SRCS_Disabled',
    'DISPID_SpeechPhraseProperties', 'ISpeechPhraseReplacement',
    'DISPID_SLWs_NewEnum', 'DISPID_SGRSTRule',
    'DISPID_SPIAudioSizeBytes', 'DISPID_SRGReset',
    'DISPID_SpeechRecognizerStatus', 'DISPID_SRRAlternates',
    'SPCT_SUB_DICTATION', 'DISPID_SpeechPhraseBuilder', 'SRAExport',
    'SRESoundEnd', 'SLTApp', 'SVP_12', 'DISPID_SRCRecognizer',
    'SPGS_EXCLUSIVE', 'SVEPhoneme', 'DISPID_SDKEnumKeys',
    'SGSExclusive', 'ISpeechLexiconWord', 'DISPID_SGRSTText',
    'DISPID_SVSInputSentencePosition', 'SP_VISEME_17', 'SVP_5',
    'DISPID_SVEStreamStart', 'SpeechInterference',
    'DISPID_SOTs_NewEnum', 'Speech_Default_Weight',
    'eLEXTYPE_RESERVED9', 'DISPID_SpeechGrammarRuleState',
    'SREPhraseStart', 'DISPID_SGRSTsItem', 'SRADynamic',
    'SpeechLoadOption', 'SAFTGSM610_22kHzMono', 'SREHypothesis',
    'ISpeechLexiconPronunciations', 'SVPAlert', 'SPEI_MIN_SR',
    'DISPID_SPIGetText', 'DISPID_SOTCategory', 'SPXMLRESULTOPTIONS',
    'SRTStandard', 'SAFTCCITT_uLaw_8kHzStereo',
    'DISPID_SABIBufferSize', 'SAFTCCITT_uLaw_22kHzStereo',
    'SpTextSelectionInformation', 'SpeechUserTraining',
    'SPPARTOFSPEECH', 'ISpNotifySink', 'SP_VISEME_15',
    'DISPID_SRCEAudioLevel', 'SPSNoun', 'ISpLexicon', 'SINoSignal',
    'SPSERIALIZEDRESULT', 'SAFTADPCM_22kHzMono', 'DISPID_SpeechAudio',
    'ISpeechPhraseElements', 'SRTExtendableParse',
    'SVSFPurgeBeforeSpeak', 'tagSPPROPERTYINFO', 'ISpeechRecoResult',
    'eLEXTYPE_PRIVATE17', 'SPINTERFERENCE_LATENCY_TRUNCATE_BEGIN',
    'DISPID_SRIsUISupported', 'SVP_0', 'SpeechGrammarTagDictation',
    'DISPID_SpeechRecoContext', 'ISpObjectTokenCategory',
    'DISPID_SLPPhoneIds', 'SpeechVoiceSkipTypeSentence',
    'SPRECORESULTTIMES', 'DISPID_SRGRules', 'ISpeechObjectToken',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_MS',
    'SWPKnownWordPronounceable', 'DISPID_SPEDisplayAttributes',
    'SPCT_SLEEP', 'DISPID_SAStatus', 'SpeechPropertyAdaptationOn',
    'SAFT48kHz16BitStereo', 'DISPID_SMSGetData',
    'eLEXTYPE_USER_SHORTCUT', 'SPAO_NONE', 'SECFIgnoreCase',
    'DISPID_SVSkip', 'DISPID_SRGIsPronounceable', 'eLEXTYPE_PRIVATE8',
    'SpSharedRecognizer', 'SREBookmark', 'SPWORDPRONOUNCEABLE',
    'DISPID_SOTsItem', 'SPSNotOverriden', 'SPPS_Verb', 'SpShortcut',
    'DISPID_SVSpeakStream', 'DISPID_SGRSAddSpecialTransition',
    'SpeechTokenShellFolder', 'SPCS_DISABLED',
    'DISPID_SVSCurrentStreamNumber', 'ISpeechPhraseAlternates',
    'SPFILEMODE', 'DISPID_SVEEnginePrivate', 'DISPID_SRRTLength',
    'SpMMAudioOut', 'DISPID_SWFEChannels', 'DISPID_SOTRemove',
    'SPEI_SOUND_END', 'DISPID_SRCEEnginePrivate', 'SPPHRASEELEMENT',
    'eLEXTYPE_PRIVATE3', 'DISPID_SpeechPhraseInfo',
    'DISPID_SOTCSetId', 'DISPID_SOTGetStorageFileName',
    'eLEXTYPE_PRIVATE13', 'SBOPause', 'ISpeechObjectTokenCategory',
    'SAFT48kHz8BitStereo', 'SSSPTRelativeToCurrentPosition',
    'SPINTERFERENCE_TOOSLOW', 'SPFM_OPEN_READWRITE',
    'DISPID_SRGCommit', 'DISPID_SAFSetWaveFormatEx',
    'SREInterference', 'DISPID_SVAudioOutput', 'DISPID_SGRsAdd',
    'SPCT_SUB_COMMAND', 'SRTSMLTimeout',
    'DISPID_SRGCmdLoadFromResource', 'DISPID_SPCLangId',
    'SREStateChange', 'SAFTADPCM_22kHzStereo', 'DISPID_SVDisplayUI',
    'SpeechRecognizerState', 'DISPID_SPRuleChildren',
    'DISPID_SGRSTNextState', 'DISPID_SVGetVoices', 'SPEI_HYPOTHESIS',
    'DISPID_SWFEBlockAlign', 'SpeechEngineConfidence',
    'DISPID_SLGetGenerationChange', 'SSFMOpenReadWrite',
    'SPDKL_CurrentConfig', 'SAFT44kHz16BitStereo',
    'DISPID_SVPriority', 'SPRS_ACTIVE', 'SPSEMANTICFORMAT',
    'SPEI_RESERVED6', 'DISPID_SRGCmdLoadFromMemory', 'SP_VISEME_3',
    'SP_VISEME_7', 'DISPID_SPPBRestorePhraseFromMemory',
    'DISPID_SMSAMMHandle', 'SRSActiveAlways', 'SASStop', 'SVP_16',
    'SPADAPTATIONRELEVANCE', 'DISPID_SGRAddState',
    'SPPS_NotOverriden', 'DISPID_SpeechAudioBufferInfo',
    'SpeechCategoryRecoProfiles', 'SRATopLevel',
    'DISPID_SPERetainedStreamOffset', 'DISPID_SPRuleConfidence',
    'eLEXTYPE_USER', 'eLEXTYPE_PRIVATE1', 'DISPID_SGRsCommitAndSave',
    'DISPID_SPCIdToPhone', 'SREStreamEnd',
    'DISPID_SPRNumberOfElements', 'SWTDeleted', 'SpMMAudioIn',
    'SPEI_PROPERTY_STRING_CHANGE', 'SDTRule', 'SPSHORTCUTPAIRLIST',
    'SPDKL_CurrentUser', 'DISPID_SpeechRecoContextEvents',
    'SPRST_ACTIVE', 'DISPID_SPEEngineConfidence',
    'DISPID_SPEDisplayText', 'ISpObjectToken', 'SVF_Emphasis',
    'DISPID_SAFGetWaveFormatEx', 'DISPID_SASState',
    'SDA_Two_Trailing_Spaces', 'ISpeechRecoResultTimes',
    'DISPID_SPIAudioStreamPosition', 'SAFTText', 'SGDisplay',
    'DISPID_SRProfile', 'DISPID_SRGCmdLoadFromObject',
    'SAFTNoAssignedFormat', 'SPWORDPRONUNCIATIONLIST',
    'SpeechPropertyLowConfidenceThreshold',
    'DISPID_SGRSAddWordTransition', 'DISPID_SpeechXMLRecoResult',
    'DISPID_SLRemovePronunciationByPhoneIds',
    'DISPID_SPAStartElementInResult', 'SpeechLexiconType',
    'SpPhraseInfoBuilder', 'SpeechStreamSeekPositionType',
    'DISPID_SLWsItem', 'SPPS_RESERVED1', 'SPAR_Low', 'SBONone',
    'DISPID_SpeechVoiceStatus', 'SASClosed', 'Speech_StreamPos_Asap',
    'SpAudioFormat', 'SP_VISEME_4', 'DISPID_SRRSaveToMemory',
    'SPRST_INACTIVE_WITH_PURGE', 'eLEXTYPE_PRIVATE15',
    'DISPID_SVAlertBoundary', 'DISPID_SLWType', 'SVPNormal',
    'DISPID_SPEAudioStreamOffset', 'Speech_Max_Word_Length',
    'SpObjectTokenCategory', 'SpeechRecoProfileProperties',
    'DISPID_SRAudioInputStream', 'DISPID_SLPPartOfSpeech',
    '__MIDL___MIDL_itf_sapi_0000_0020_0001',
    'DISPID_SpeechPhraseRules', 'DISPID_SRRRecoContext',
    'DISPID_SPIGrammarId', 'STSF_AppData', 'SPAS_CLOSED',
    'DISPID_SRGCmdSetRuleIdState', 'SP_VISEME_18',
    'DISPID_SVEBookmark', 'SSSPTRelativeToEnd', 'SASPause',
    'DISPID_SRCEEndStream', 'ISpNotifyTranslator',
    'DISPID_SVSVisemeId', 'DISPID_SVEViseme', 'SpeechRunState',
    'DISPID_SBSRead', 'DISPID_SRCEFalseRecognition', 'SRSActive',
    'DISPID_SPRulesCount', 'DISPID_SVSInputWordPosition', 'SVP_17',
    'ISpRecoCategory', 'SITooLoud', '_ISpeechRecoContextEvents',
    'DISPID_SOTDisplayUI', 'eLEXTYPE_PRIVATE10',
    'SPEI_RECO_OTHER_CONTEXT', 'SRERecognition',
    'DISPID_SPIStartTime', 'DISPID_SpeechBaseStream',
    'DISPID_SAFGuid', 'DISPID_SLWPronunciations',
    'ISpeechTextSelectionInformation',
    'DISPID_SRCCreateResultFromMemory', 'SPINTERFERENCE',
    'DISPID_SRGDictationSetState', 'WAVEFORMATEX', 'DISPID_SPPId',
    'DISPID_SRGCmdSetRuleState', 'DISPID_SpeechVoiceEvent',
    'DISPID_SPELexicalForm', 'SVSFParseSapi', 'IEnumString',
    'DISPID_SRCVoicePurgeEvent', 'SVEVoiceChange', 'SVP_20',
    'DISPIDSPTSI_ActiveLength', 'DISPID_SRRTStreamTime',
    'SREStreamStart', 'SPWP_UNKNOWN_WORD_PRONOUNCEABLE',
    'DISPID_SpeechGrammarRuleStateTransition', 'DISPID_SPIEngineId',
    'DISPID_SpeechWaveFormatEx', 'SPINTERFERENCE_NOSIGNAL',
    'SPGRAMMARSTATE', 'SVP_10', 'SPEI_TTS_BOOKMARK',
    'SGLexicalNoSpecialChars', 'DISPID_SRRGetXMLErrorInfo',
    'SPVISEMES', 'DISPID_SVIsUISupported', 'DISPID_SOTCId',
    'DISPID_SpeechLexiconWords', 'SGRSTTWord', 'DISPID_SRCPause',
    'SP_VISEME_8', 'DISPID_SBSFormat', 'ISpeechPhraseRules',
    'SVSFIsXML', 'SpeechEmulationCompareFlags', 'SAFT32kHz8BitMono',
    'DISPID_SVSpeak', 'DISPID_SPEsCount', 'ISpeechAudioFormat',
    'SPPS_Noun', 'DISPID_SRCreateRecoContext',
    'SWPUnknownWordPronounceable', 'SDTAudio',
    'DISPID_SVSLastBookmarkId', 'SAFT24kHz8BitMono',
    'ISpeechBaseStream', 'DISPID_SRSNumberOfActiveRules',
    'eLEXTYPE_PRIVATE11', 'SAFTDefault', 'SpVoice',
    'SDKLCurrentConfig', 'DISPID_SRRecognizer', 'ISpPhoneConverter',
    'SAFT22kHz8BitStereo', 'SPEVENTSOURCEINFO', 'SAFT32kHz8BitStereo',
    'DISPID_SRGetPropertyString', 'DISPID_SPRules_NewEnum', 'SVP_2',
    'ISpRecognizer', 'SPVPRI_OVER', 'DISPID_SRCEPhraseStart',
    'SPINTERFERENCE_NONE', 'SPSInterjection', 'ISpStream',
    'SpeechBookmarkOptions', 'DISPID_SPPName',
    'SREPropertyStringChange', 'DISPID_SPEAudioTimeOffset',
    'SPSSuppressWord', 'DISPID_SRAudioInput',
    'ISpeechPhraseProperties', 'DISPID_SPRs_NewEnum',
    'DISPID_SDKCreateKey', 'SPWT_PRONUNCIATION', 'SPGRAMMARWORDTYPE',
    'DISPID_SPEPronunciation', 'SpeechCategoryAudioOut',
    'SpNullPhoneConverter', 'SP_VISEME_21', 'DISPID_SOTDataKey',
    'SpeechDisplayAttributes', 'ISpeechObjectTokens',
    'DISPID_SCSBaseStream', 'DISPID_SAFType', 'SVEAllEvents',
    'SVSFIsFilename', 'SpResourceManager', 'SpeechAddRemoveWord',
    'SPWT_LEXICAL_NO_SPECIAL_CHARS', 'DISPID_SPPEngineConfidence',
    'SREPrivate', 'SPEI_WORD_BOUNDARY', 'SAFT24kHz16BitMono',
    'DISPID_SPIRule', 'SPDKL_DefaultLocation', 'ISpeechFileStream',
    'ISpeechLexiconWords', 'SRERecoOtherContext', 'SLOStatic',
    'SpeechTokenIdUserLexicon', 'SPDATAKEYLOCATION', 'SPAUDIOSTATUS',
    'SAFTADPCM_11kHzMono', 'DISPID_SRSetPropertyString',
    'SAFT16kHz8BitStereo', 'DISPID_SLPsCount', 'SpLexicon',
    'DISPID_SOTCDefault', 'DISPID_SOTGetDescription',
    'STSF_FlagCreate', 'DISPID_SPACommit', 'DISPID_SMSALineId',
    'ISpRecognizer3', 'DISPID_SAEventHandle', 'DISPID_SLPLangId',
    'SPAUDIOOPTIONS', 'SPEVENTENUM', 'DISPID_SRCEInterference',
    'DISPID_SRCEBookmark', 'SGRSTTRule', 'DISPID_SVRate',
    'ISpRecoContext2', 'DISPID_SASNonBlockingIO',
    'SAFT12kHz16BitMono', 'ISpPhraseAlt', 'SPSHT_Unknown',
    'DISPID_SRIsShared', 'SP_VISEME_20', 'DISPID_SRCEStartStream',
    'SPEI_SR_BOOKMARK', 'STCAll', 'SpeechDictationTopicSpelling',
    'SREPropertyNumChange', 'DISPID_SVSInputWordLength',
    'SPCS_ENABLED', 'SPEI_RESERVED5', 'SPRECOCONTEXTSTATUS', 'SVP_14',
    'SpeechPropertyResponseSpeed', 'SGDSActiveUserDelimited',
    'DISPID_SRGetRecognizers',
    'SpeechPropertyNormalConfidenceThreshold', 'DISPID_SPRuleName',
    'SAFTCCITT_uLaw_44kHzStereo', 'SRADefaultToActive',
    'SpeechVoiceCategoryTTSRate', 'SSTTDictation', 'SRAImport',
    'SPEI_REQUEST_UI', 'DISPID_SPIProperties', 'SRTEmulated',
    'SpeechVoiceSpeakFlags', 'SDTPronunciation',
    'SpeechVisemeFeature', 'STCInprocHandler', 'DISPID_SLPSymbolic',
    'SAFTExtendedAudioFormat', 'DISPID_SRGSetWordSequenceData',
    'ISpeechXMLRecoResult', 'SVSFVoiceMask', 'DISPID_SRCBookmark',
    'DISPID_SRRGetXMLResult', 'SAFT16kHz16BitStereo',
    'eLEXTYPE_PRIVATE6', 'SGRSTTEpsilon', 'DISPID_SOTSetId',
    'SAFT8kHz8BitMono', 'DISPID_SRCEHypothesis', 'ISpShortcut',
    'SPPS_Unknown', 'DISPID_SDKDeleteValue', 'SVEWordBoundary',
    'STCLocalServer', 'SASRun', 'DISPID_SGRSTWeight',
    'SPSMF_SRGS_SAPIPROPERTIES', 'SPTEXTSELECTIONINFO',
    'SpeechRuleAttributes', 'DISPID_SLAddPronunciation',
    'SpeechSpecialTransitionType', 'SPBO_NONE', 'SPSVerb',
    'DISPID_SGRInitialState', 'DISPID_SRCVoice', 'DISPID_SLPType',
    'DISPID_SGRSTType', 'tagSPTEXTSELECTIONINFO',
    'DISPID_SRCESoundEnd', 'ISpDataKey', 'DISPID_SVSPhonemeId',
    'DISPID_SOTsCount', 'SPBO_TIME_UNITS', 'DISPID_SMSADeviceId',
    'DISPID_SGRAttributes', 'SPINTERFERENCE_NOISE', 'SPLO_STATIC',
    'SPEI_SR_RETAINEDAUDIO', 'SPRS_ACTIVE_WITH_AUTO_PAUSE',
    'SAFT8kHz16BitMono', 'ISpeechLexicon',
    'DISPID_SRGDictationUnload', 'SVP_19', '__MIDL_IWinTypes_0009',
    'SSSPTRelativeToStart', 'DISPID_SLRemovePronunciation',
    'DISPID_SPANumberOfElementsInResult',
    'DISPID_SRCEPropertyStringChange', 'DISPID_SABIEventBias',
    'SAFT12kHz8BitMono', 'SECLowConfidence',
    'DISPID_SpeechGrammarRules', 'SPWF_SRENGINE',
    'DISPID_SABIMinNotification', 'SPEI_SR_AUDIO_LEVEL',
    'SVSFNLPMask', 'ISpEventSink', 'SVEPrivate',
    'DISPID_SPCPhoneToId', 'DISPID_SpeechAudioFormat',
    'IEnumSpObjectTokens', 'STSF_LocalAppData', 'DISPIDSPTSI',
    'DISPID_SPPsItem', 'SDA_One_Trailing_Space', 'DISPID_SVVoice',
    'SVP_8', 'SP_VISEME_12', 'ISpeechRecoContext',
    'SVEEndInputStream', 'DISPID_SASCurrentSeekPosition',
    'SPBO_PAUSE', 'SDTDisplayText', 'SPEI_END_SR_STREAM',
    'SpMemoryStream', 'DISPID_SpeechAudioStatus', 'SFTSREngine',
    'DISPIDSPRG', 'SREAudioLevel', 'ISpeechCustomStream',
    'DISPID_SRStatus', 'DISPID_SDKSetBinaryValue',
    'DISPID_SPIRetainedSizeBytes', 'SpObjectToken',
    'SPPHRASEREPLACEMENT', 'SAFT48kHz8BitMono', 'SPCATEGORYTYPE',
    'DISPID_SLPs_NewEnum', 'DISPID_SVEStreamEnd',
    'DISPID_SVSpeakCompleteEvent', 'eLEXTYPE_PRIVATE16',
    'SpeechCategoryAppLexicons', 'ISpeechPhraseRule',
    'DISPID_SpeechPhraseReplacements', 'SVP_1', 'SPEI_PHONEME',
    'SPEI_TTS_PRIVATE', 'DISPID_SLGetWords', 'DISPID_SRGRecoContext',
    'SGSDisabled', 'DISPID_SpeechRecoResult2', 'SPEI_START_SR_STREAM',
    'SGRSTTTextBuffer', 'SPBOOKMARKOPTIONS',
    'ISpeechGrammarRuleStateTransitions', 'SpWaveFormatEx',
    'SDKLDefaultLocation', 'DISPID_SVEPhoneme',
    'DISPID_SOTIsUISupported', 'SAFT16kHz16BitMono',
    'SpeechGrammarRuleStateTransitionType', 'DISPID_SVGetProfiles',
    'SPRECOGNIZERSTATUS', 'DISPID_SOTCGetDataKey',
    'DISPID_SPISaveToMemory', 'DISPID_SPERequiredConfidence',
    'SPAS_PAUSE', 'SGDSActiveWithAutoPause', 'ISpSerializeState',
    'SPPHRASE', 'SPEI_RESERVED1', 'DISPID_SpeechPhraseAlternate',
    'SPAUDIOBUFFERINFO', 'SPPS_RESERVED3', 'eLEXTYPE_RESERVED6',
    'DISPID_SpeechPhraseAlternates', 'ISpeechPhraseProperty',
    'SpeechAllElements', 'DISPID_SpeechMMSysAudio',
    'DISPID_SpeechGrammarRuleStateTransitions',
    'DISPID_SPARecoResult', 'ISpRecoResult', 'SAFT22kHz16BitMono',
    'SPRST_ACTIVE_ALWAYS', 'ISpeechAudioBufferInfo', 'SPEI_RESERVED3',
    'DISPID_SpeechObjectTokens', 'SAFT8kHz16BitStereo', 'SPRULESTATE',
    'DISPID_SRSCurrentStreamPosition', 'DISPID_SRCESoundStart',
    'DISPID_SPEAudioSizeBytes', 'DISPID_SVSLastBookmark',
    'DISPID_SpeechVoice', 'DISPID_SVAudioOutputStream', 'SVF_None',
    'SpeechCategoryPhoneConverters', 'SDTReplacement',
    'SECNormalConfidence', 'DISPID_SpeechPhoneConverter',
    'SPVPRI_ALERT', 'SPEI_PHRASE_START', 'DISPID_SWFESamplesPerSec',
    'DISPID_SRCAudioInInterferenceStatus', 'SVSFParseAutodetect',
    'ISpeechPhraseAlternate', 'SPSHORTCUTTYPE',
    'SPEI_FALSE_RECOGNITION', 'SAFT44kHz8BitStereo',
    'DISPID_SRSClsidEngine', 'SPWT_DISPLAY',
    'IInternetSecurityManager', 'DISPID_SPAsItem',
    'DISPID_SPRuleFirstElement', 'ISpRecoContext', 'SVP_11',
    'DISPID_SRCEPropertyNumberChange', 'DISPID_SVGetAudioInputs',
    'SpeechAudioFormatType', 'ISpStreamFormat', 'SP_VISEME_11',
    'DISPID_SFSClose', 'DISPID_SRDisplayUI',
    'SpeechGrammarTagUnlimitedDictation', 'DISPID_SRCCreateGrammar',
    'SPEI_PROPERTY_NUM_CHANGE', 'SSFMOpenForRead', 'DISPID_SVVolume',
    'SRARoot', 'SPFM_NUM_MODES', 'DISPID_SGRsItem', 'SLTUser',
    'SAFT12kHz8BitStereo', 'DISPID_SPRuleNumberOfElements', 'SVP_4',
    'SP_VISEME_2', 'DISPID_SpeechObjectToken', 'SDTAlternates',
    'SDKLCurrentUser', 'DISPID_SREmulateRecognition',
    'ISpeechLexiconPronunciation', 'DISPID_SRCERequestUI',
    'SRTAutopause', 'DISPID_SVWaitUntilDone', 'DISPID_SFSOpen',
    'SVSFDefault', 'SPEI_TTS_AUDIO_LEVEL', 'DISPID_SRCResume',
    'DISPID_SRRAudio', 'SAFTCCITT_ALaw_22kHzStereo',
    'DISPID_SGRSTPropertyValue', 'SPVPRI_NORMAL',
    'SpPhoneticAlphabetConverter', 'DISPID_SABufferInfo',
    'DISPIDSPTSI_SelectionLength', 'DISPID_SLGetPronunciations',
    'DISPID_SGRsCount', 'DISPID_SPPs_NewEnum', 'SPRST_INACTIVE',
    'SITooSlow', 'SPGS_ENABLED', 'SAFTADPCM_8kHzStereo',
    'SPSModifier', 'DISPID_SPEsItem', 'SAFT24kHz8BitStereo',
    'DISPID_SpeechPhraseElement', 'SVP_9', 'DISPID_SPEs_NewEnum',
    'SPEI_SENTENCE_BOUNDARY', 'DISPID_SGRsFindRule', 'SP_VISEME_9',
    'DISPID_SpeechLexiconWord', 'ISpeechDataKey', 'DISPID_SRCState',
    'SPBO_AHEAD', 'SPPS_RESERVED2', 'SpeechTokenKeyAttributes',
    'DISPID_SRGId', 'SPEI_MAX_SR', 'DISPID_SPRsItem', 'SGSEnabled',
    'SAFT8kHz8BitStereo', 'DISPID_SVSRunningState', 'SPWORDTYPE',
    'SAFT22kHz8BitMono', 'SREAdaptation', 'DISPID_SRRAudioFormat',
    'DISPID_SPIElements', 'SPCT_COMMAND',
    'DISPID_SRGCmdLoadFromProprietaryGrammar',
    'DISPID_SPEAudioSizeTime', 'ISpeechMemoryStream',
    'SpeechFormatType', 'SGDSActive', 'SpeechAudioFormatGUIDWave',
    'DISPID_SpeechObjectTokenCategory', 'SPXRO_Alternates_SML',
    'DISPID_SRCRetainedAudioFormat', 'STSF_CommonAppData',
    'SPEI_ADAPTATION', 'DISPID_SRGetPropertyNumber',
    'SpeechVoiceEvents', 'SPRULE', 'SRAORetainAudio',
    'SPSEMANTICERRORINFO', 'SP_VISEME_14', 'SWTAdded',
    'SpeechTokenKeyUI', 'SpeechPropertyResourceUsage', 'SPEI_MAX_TTS',
    'DISPID_SRRSpeakAudio', 'SPSLMA', 'eLEXTYPE_MORPHOLOGY',
    'eLEXTYPE_RESERVED10', 'eLEXTYPE_PRIVATE19', 'SPSERIALIZEDPHRASE',
    'ISpPhrase', 'ISpeechGrammarRuleState', 'ISpeechResourceLoader',
    'DISPID_SVStatus', 'SGRSTTDictation', 'DISPID_SVPause',
    'SpeechMicTraining', 'DISPID_SRCERecognition', 'SPPS_Noncontent',
    'SPSUnknown', 'SAFTCCITT_uLaw_11kHzStereo',
    'DISPID_SASCurrentDevicePosition', 'DISPID_SGRSRule',
    'STCInprocServer', 'DISPID_SRState', 'SpNotifyTranslator',
    'SVSFlagsAsync', 'ISpeechRecoGrammar', 'eLEXTYPE_RESERVED4',
    'DISPID_SDKOpenKey', 'SPEI_RECOGNITION',
    'SpeechRegistryLocalMachineRoot', 'SAFT32kHz16BitStereo',
    'SGPronounciation', 'DISPID_SpeechPhraseElements',
    'SDA_No_Trailing_Space', 'SECFEmulateResult',
    'SAFT32kHz16BitMono', 'SPWP_UNKNOWN_WORD_UNPRONOUNCEABLE',
    'SP_VISEME_6', 'SAFTCCITT_uLaw_11kHzMono',
    'SAFTADPCM_11kHzStereo', 'SPPHRASEPROPERTY',
    'ISpeechPhraseElement', 'ISpeechGrammarRule', 'SpStream',
    'ISpMMSysAudio', 'DISPID_SVSInputSentenceLength', 'SVP_21',
    'SINone', 'SRSInactiveWithPurge', 'SRERequestUI', 'SPPHRASERULE',
    'SSTTTextBuffer', 'DISPID_SpeechCustomStream',
    'SPSMF_SAPI_PROPERTIES', 'SRSInactive', 'SPSHT_OTHER',
    'DISPID_SpeechLexicon', 'ISpVoice', 'DISPID_SRSAudioStatus',
    'SpUnCompressedLexicon', 'SAFT11kHz8BitStereo', 'SREAllEvents',
    'DISPID_SpeechRecoResult', 'SRESoundStart', 'DISPID_SLWLangId',
    'SVPOver', 'SPEI_START_INPUT_STREAM',
    'DISPID_SPEActualConfidence', 'SPWORDLIST', 'SPGS_DISABLED',
    'SPEI_VOICE_CHANGE', 'SpeechVisemeType', 'DISPID_SGRs_NewEnum',
    'SVP_7', 'DISPID_SGRSTPropertyId', 'ISpPhoneticAlphabetConverter',
    'DISPID_SpeechLexiconProns', 'eLEXTYPE_PRIVATE20',
    'SAFT48kHz16BitMono', 'SPSMF_SRGS_SEMANTICINTERPRETATION_W3C',
    'DISPID_SBSSeek', 'DISPID_SPAs_NewEnum', 'eLEXTYPE_PRIVATE9',
    'ISpXMLRecoResult', 'DISPID_SGRSTPropertyName',
    'SAFT22kHz16BitStereo', 'DISPID_SpeechRecognizer',
    'ISpResourceManager', 'DISPID_SVSLastStreamNumberQueued',
    'SPEI_SOUND_START', 'DISPID_SWFEExtraData', 'SPEI_SR_PRIVATE',
    'SECFIgnoreKanaType', 'SRCS_Enabled', 'ISpProperties',
    'DISPID_SVSLastResult', 'SFTInput', 'SPPROPERTYINFO',
    'SpeechRegistryUserRoot', 'DISPID_SPILanguageId', 'SP_VISEME_0',
    'SVP_6', 'DISPID_SPPFirstElement', 'SpeechAudioVolume',
    'DISPID_SDKGetlongValue', 'SVSFNLPSpeakPunc', 'ISpAudio',
    'SVESentenceBoundary', 'DISPID_SVResume', 'DISPID_SGRAddResource',
    'SpeechRuleState', 'DISPID_SPRuleId', 'DISPID_SDKSetStringValue',
    'DISPID_SRRDiscardResultInfo', 'DISPID_SAVolume', 'SINoise',
    'DISPID_SPERetainedSizeBytes', 'DISPID_SPRuleParent',
    'ISpeechAudio', 'DISPID_SRRTTickCount',
    'ISpeechPhraseInfoBuilder', 'SPLEXICONTYPE',
    'DISPID_SPPConfidence', 'SpeechEngineProperties',
    'SWPUnknownWordUnpronounceable', 'SPEI_ACTIVE_CATEGORY_CHANGED',
    'SAFT12kHz16BitStereo', 'SPAR_Unknown', 'SAFTGSM610_8kHzMono',
    'SPWORDPRONUNCIATION', 'SPINTERFERENCE_TOOQUIET',
    'DISPID_SWFEFormatTag', 'SVP_15', 'SP_VISEME_1',
    'eWORDTYPE_ADDED', 'SPAR_Medium', 'SECHighConfidence',
    'SDKLLocalMachine', 'SVF_Stressed', 'SRSEDone', 'SPPS_RESERVED4',
    'SPCT_DICTATION', 'DISPID_SASetState',
    'DISPID_SOTCEnumerateTokens', 'DISPID_SPIGetDisplayAttributes',
    'SECFNoSpecialChars',
    'DISPID_SVAllowAudioOuputFormatChangesOnNextSet', 'SVEViseme',
    'DISPID_SRGetFormat', 'DISPID_SRGDictationLoad', 'SSTTWildcard',
    'DISPID_SPPParent', 'SDTProperty', 'SPEI_END_INPUT_STREAM',
    'eLEXTYPE_APP', 'DISPID_SPPValue', 'DISPID_SLWWord',
    '_ISpeechVoiceEvents', 'DISPID_SRSCurrentStreamNumber',
    'DISPID_SPRDisplayAttributes', 'SP_VISEME_13', 'DISPID_SOTId',
    'SPRST_NUM_STATES', 'DISPID_SLPsItem', 'SVEBookmark',
    'eWORDTYPE_DELETED', 'ISpeechGrammarRules',
    'SpeechDataKeyLocation', 'DISPID_SRCEAdaptation',
    'DISPID_SpeechFileStream', 'DISPID_SWFEAvgBytesPerSec',
    'SAFTCCITT_ALaw_11kHzMono', 'eLEXTYPE_LETTERTOSOUND',
    'SPDKL_LocalMachine', 'ISpeechVoice', 'SpeechWordPronounceable',
    'ISpeechPhraseReplacements', 'eLEXTYPE_PRIVATE5',
    'DISPID_SPAPhraseInfo', 'DISPID_SPRulesItem',
    'SAFTCCITT_ALaw_44kHzStereo', 'DISPID_SDKEnumValues',
    'eLEXTYPE_PRIVATE2', 'SAFT11kHz16BitStereo', 'SPPS_Modifier',
    'SPSFunction', 'DISPID_SOTGetAttribute', 'SPBINARYGRAMMAR',
    'SAFT11kHz16BitMono', 'DISPID_SPAsCount', 'DISPID_SVEVoiceChange',
    'SAFTGSM610_44kHzMono', 'DISPID_SpeechGrammarRule',
    'SPVOICESTATUS', 'tagSTATSTG', 'SPEI_INTERFERENCE',
